                ...
                <div class="form-row mb-2">
                    <!-- <div class="form-group col-md-3 d-none">
                        ...
                        <select name="currency" v-model="currency" v-validate="'required'" class="form-control form-control-custom custom-select">
                            ...
                            <option v-for="(currency_item, index) in currency_list" v-bind:value="currency_item.currency_code" v-bind:key="index" v-bind:selected="currency_item.currency_code === 'INR'">
