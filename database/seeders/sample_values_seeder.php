            ...
            foreach ($active_stores as $active_store) {
                ...
                $categories = [
                    "Digital Camera" => [
                        ...
                        "items" => [
                            [
                                "item" => "Canon 550D With 18-55 Lens",
                                "price" => 26500.00,
                                "variants" => [
                                    [
                                        "item" => "Canon 550 D",
                            ...
                            [
                                "item" => "Nikon D3200 With 18-55 Lens",
                                "price" => 26500.00,
                                "variants" => [
                                    [
                                        "item" => "Nikon D3200",
                            ...
                            [
                                "item" => "Canon EOS-600D With EF 18-55 Lens",
                                "price" => 23500.00,
                                "variants" => [
                                    [
                                        "item" => "Canon EOS-600D",
                    ...
                    "Camera Lens" => [
                        ...
                        "items" => [
                            [
                                "item" => "Canon -75-300MM With F/4-5.6 Lens",
                                "price" => 15000.00,
                                "variants" => [
                                    [
                                        "item" => "Canon -75-300MM",
                            ...
                            [
                                "item" => "Nikon 55-200mm With F/4-5.6G Lens",
                                "price" => 10000.00,
                                "variants" => [
                                    [
                                        "item" => "Nikon 55-200mm",
        ...
        if(count($active_stores)>0){
            ...
            foreach ($active_stores as $active_store) {
                ...
                for($j=0; $j<$count; $j++){
                    ...
                    $waiter_user = UserModel::select('slack')->where('email', 'waiter1@worthyten.com')->first();
