        ...
        <div class="container-fluid pl-0 pr-0">
            <div class="content mt-5 pl-3 pr-3">
                ...
                <?php if($db_connection && $db_table_exists == true){ ?>
                    ...
                    <div class="d-flex justify-content-center text-title mb-3 text-secondary">Activate Purchase Code | <a href="https://weadown.com" target="_blank">weadown.com</a></div>
