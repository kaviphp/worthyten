...
if (isset($_POST['purchase_code']) && $_POST['purchase_code'] != '') {
    ...
    $output_json = base64_decode('ewogICJzdGF0dXNfY29kZSI6MjAwLAogICJtc2ciOiJMaWNlbnNlIHZlcmlmaWVkIGJ5IG51bGxjYXZlLmNsdWIiLAogICJkYXRhIjogewogICAgImFjdGl2YXRpb25fY29kZSI6ICJ4eHh4eHh4eC14eHh4LXh4eHgteHh4eC14eHh4eHh4eHh4eHgiCiAgfQp9');
